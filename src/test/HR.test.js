...
test('renders HR component and displays HR requests', () => {
    const hrRequests = [
        { requestId: 'REQ001', staffCount: 5, responsibilities: 'Manage team operations', timeFrame: 'Q4 2023', status: 'Submitted' },
        { requestId: 'REQ002', staffCount: 3, responsibilities: 'Assist with project', timeFrame: 'Q1 2024', status: 'Pending' },
    ];

    render(
        <AuthProvider>
            <HR hrRequests={hrRequests} updateHRRequestStatus={mockUpdateHRRequestStatus} />
        </AuthProvider>
    );
